        ...
        <v-row>
            <v-col lg="7" cols="12">
                <v-alert dense text type="success">
                    Login Successfully! Welcome to <strong>ScanSaver</strong>
                </v-alert>
                <v-row>
        ...
        data() {
            return {
                activityLog: [
                    ...
                    {title: 'Total Users', amount: 3433, icon: 'mdi-account-group-outline', color: 'green darken-2'},
                    {title: 'Total Sale', amount: 3433, icon: 'mdi-account-group-outline', color: 'blue-grey darken-1'},
                    {
                        title: 'Pending Request & Complaints ',
                        amount: 3433,
